 ...
 */
public class WeightedFieldFragListEx extends WeightedFieldFragList {
   ...
   */
  public WeightedFieldFragListEx(int fragCharSize ) {
    super( fragCharSize );
  }

  /* (non-Javadoc)
   * @see org.apache.lucene.search.vectorhighlight.FieldFragList#add( int startOffset,
  ...
  public void add( int startOffset, int endOffset, List<WeightedPhraseInfo> phraseInfoList ) {
    ...
    for ( SubInfo tempSubInfo : tempSubInfos ) {
      ...
      float subInfoBoost = tempSubInfo.getBoost();
